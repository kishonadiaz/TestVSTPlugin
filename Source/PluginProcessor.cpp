...
TestPluginAudioProcessor::createParamterLayout() 
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Freq", "Peak Freq", juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f), 760.f));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Quality", "Peak Quality", juce::NormalisableRange<float>(.1f, 18.f, 0.05f, 1.f), 1.f));
    ...
    layout.add(std::make_unique<juce::AudioParameterChoice>("Hihgut Slope", "HighCut Slope", stringArray, 0));
